...
#ifndef FLUTTER_NFC_READER_SWIFT_H
#define FLUTTER_NFC_READER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="flutter_nfc_reader",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18flutter_nfc_reader27SwiftFlutterNfcReaderPlugin") SWIFT_AVAILABILITY(ios,introduced=11.0)
...
@interface SwiftFlutterNfcReaderPlugin (SWIFT_EXTENSION(flutter_nfc_reader)) <FlutterStreamHandler>
...
SWIFT_AVAILABILITY(ios,introduced=11.0)
@interface SwiftFlutterNfcReaderPlugin (SWIFT_EXTENSION(flutter_nfc_reader)) <NFCNDEFReaderSessionDelegate>
