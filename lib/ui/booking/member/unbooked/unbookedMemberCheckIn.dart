...
class UnbookedMemberCheckIn extends StatefulWidget {
  final Customer cust;

  UnbookedMemberCheckIn({Key key, this.cust}) : super(key: key);
  @override
  _UnbookedMemberCheckIn createState() => _UnbookedMemberCheckIn();
}

class _UnbookedMemberCheckIn extends State<UnbookedMemberCheckIn> {
